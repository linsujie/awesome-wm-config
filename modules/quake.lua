...
function quake:new(config)
   ...
   conf.screen  = conf.screen  or capi.mouse.screen.index
   ...
   max_opacity  = conf.max_opacity  or 1        -- maximum opacity
   min_opacity  = conf.min_opacity  or 0.2      -- minimum opacity

   conf.max_opacity = max_opacity
   conf.min_opacity = min_opacity
...
function quake:opaque_change(v)
  ...
  local opacity = client.opacity + v
   if opacity and self.min_opacity <= opacity and opacity <= self.max_opacity then
